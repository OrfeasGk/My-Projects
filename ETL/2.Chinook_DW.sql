...
create table DimEmployee(
	...
	EmployeeTitle NVARCHAR(30),  -- check
...
create table DimCustomer (
	...
	CustomerCompany NVARCHAR(80), -- check
	CustomerCountry NVARCHAR(40),
	CustomerState NVARCHAR(40), -- check
	CustomerCity NVARCHAR(40), -- check
	CustomerPostalCode NVARCHAR(10), -- check
	SupportRepId INT,
	RowIsCurrent INT DEFAULT 1 NOT NULL,
	RowStartDate DATE DEFAULT '1899-12-31' NOT NULL,
	RowEndDate DATE DEFAULT '9999-12-31' NOT NULL,
...
CREATE TABLE DimTrack(
	...
	RowEndDate DATE DEFAULT '9999-12-31' NOT NULL,
	RowChangeReason varchar(200) NULL,
	CONSTRAINT PK_ProductKey PRIMARY KEY CLUSTERED (TrackKey)
);
...
DECLARE @StartDate DATETIME = (select min(cast(InvoiceDate as Date)) as StartDate 
	from Chinook.dbo.Invoice) --Starting value of Date Range 
DECLARE @EndDate DATETIME = (select max(cast(InvoiceDate as Date)) as EndDate 
	from Chinook.dbo.Invoice) --End Value of Date Range
